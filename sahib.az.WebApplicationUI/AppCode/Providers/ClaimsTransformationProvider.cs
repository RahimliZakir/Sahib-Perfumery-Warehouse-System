...
namespace sahib.az.WebApplicationUI.AppCode.Providers
{
    public class ClaimsTransformationProvider : IClaimsTransformation
    {
        readonly UserManager<AppUser> userManager;
        readonly SahibDbContext context;

        public ClaimsTransformationProvider(UserManager<AppUser> userManager, SahibDbContext context)
        {
